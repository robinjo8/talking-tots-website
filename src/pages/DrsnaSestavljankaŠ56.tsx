...
export default function DrsnaSestavljankaŠ56() { return (<AgeGatedRoute requiredAgeGroup="5-6"><DrsnaSestavljankaŠ56Content /></AgeGatedRoute>); }
...
function DrsnaSestavljankaŠ56Content() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('sliding_puzzle', 'sliding_puzzle_š_5-6'); setShowNewGameButton(true); };
  ...
  return (
    <div className="fixed inset-0 overflow-auto select-none" style={{ backgroundImage: 'url(https://ecmtctwovkheohqwahvt.supabase.co/storage/v1/object/public/ozadja/zeleno_ozadje.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
      <div className="min-h-full flex flex-col items-center justify-center p-4 pb-24"><SlidingPuzzle key={puzzleKey} imageUrl={imageUrl} onComplete={handleComplete} /></div>
