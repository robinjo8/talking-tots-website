...
export default function SpominŠ() {
  ...
  const { cards, isLoading, error, flipCard, resetGame, gameCompleted, matchedPairs, totalPairs, isCheckingMatch, showPairDialog, currentMatchedPair, handlePairDialogContinue, handlePairUnmatch } = useMemoryGameŠ();
  ...
  const handleStarClaimed = () => {
    if (!gameCompletedRef.current) {
      ...
      recordGameCompletion('memory', 'memory_š_game');
    }
