...
import { wordsDataŠSredinaKonec } from "@/data/bingoWordsSHSredinaKonec";
...
export default function ArtikulacijaVajeŠSredinaKonec() {
  ...
  const {
    ...
    closePopup,
    resetGame
  } = useBingoGame({ words: wordsDataŠSredinaKonec, minWordsForWin: 8 });
  ...
  const handleStarClaimed = () => {
    recordExerciseCompletion('artikulacija_bingo_š');
    setStarClaimed(true);
    setShowCongratulations(false);
