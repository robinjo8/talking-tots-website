...
export default function SestavljankeŠ56() {
  return (
    <AgeGatedRoute requiredAgeGroup="5-6">
      <SestavljankeŠ56Content />
    </AgeGatedRoute>
  );
}

function SestavljankeŠ56Content() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('puzzle', 'puzzle_š_12'); setShowNewGameButton(true); };
