...
export default function SpominC() {
  ...
  const { cards, isLoading, error, flipCard, resetGame, gameCompleted, matchedPairs, totalPairs, isCheckingMatch, showPairDialog, currentMatchedPair, handlePairDialogContinue, handlePairUnmatch } = useMemoryGameC();
  ...
  const handleStarClaimed = () => {
    if (!gameCompletedRef.current) {
      ...
      recordGameCompletion('memory', 'memory_c_game');
    }
