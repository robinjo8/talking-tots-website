...
export default function DrsnaSestavljankaŠ78() { return (<AgeGatedRoute requiredAgeGroup="7-8"><DrsnaSestavljankaŠ78Content /></AgeGatedRoute>); }
...
function DrsnaSestavljankaŠ78Content() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('sliding_puzzle', 'sliding_puzzle_š_7-8'); setShowNewGameButton(true); };
