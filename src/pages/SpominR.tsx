...
export default function SpominR() {
  ...
  const currentLetter = decodeURIComponent(location.pathname.split('-').pop() || 'r').toUpperCase();
  const { cards, isLoading, error, flipCard, resetGame, gameCompleted, matchedPairs, totalPairs, isCheckingMatch, showPairDialog, currentMatchedPair, handlePairDialogContinue, handlePairUnmatch } = useMemoryGameR();
  ...
  const handleStarClaimed = () => {
    if (!gameCompletedRef.current) {
      ...
      recordGameCompletion('memory', 'memory_r_game');
    }
