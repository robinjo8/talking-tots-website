...
export default function SpominS() {
  ...
  const currentLetter = decodeURIComponent(location.pathname.split('-').pop() || 's').toUpperCase();
  const { cards, isLoading, error, flipCard, resetGame, gameCompleted, matchedPairs, totalPairs, isCheckingMatch, showPairDialog, currentMatchedPair, handlePairDialogContinue, handlePairUnmatch } = useMemoryGameS();
