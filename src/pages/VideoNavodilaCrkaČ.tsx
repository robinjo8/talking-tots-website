...
const VideoNavodilaCrkaČ = () => {
  const videoUrl = "https://ecmtctwovkheohqwahvt.supabase.co/storage/v1/object/public/video-navodila/Glas%20C_1(video).mp4";
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <PageHeader title="Video navodila - Č" backPath="/video-navodila" />
...
export default VideoNavodilaCrkaČ;
