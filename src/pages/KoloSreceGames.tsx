...
const wheelLetters = [
  ...
  { id: "f", letter: "F", title: "Glas F", description: "Zavrti kolo besed in vadi izgovorjavo glasu F na začetku besed", gradient: "from-app-orange/20 to-app-yellow/20", image: "zmajcek_crka_F.webp", path: "/govorne-igre/kolo-srece/f" },
  { id: "g", letter: "G", title: "Glas G", description: "Zavrti kolo besed in vadi izgovorjavo glasu G na začetku besed", gradient: "from-dragon-green/20 to-app-teal/20", image: "zmajcek_crka_G.webp", path: "/govorne-igre/kolo-srece/g" },
  { id: "h", letter: "H", title: "Glas H", description: "Zavrti kolo besed in vadi izgovorjavo glasu H na začetku besed", gradient: "from-app-blue/20 to-app-purple/20", image: "zmajcek_crka_H.webp", path: "/govorne-igre/kolo-srece/h" },
  ...
  { id: "v", letter: "V", title: "Glas V", description: "Zavrti kolo besed in vadi izgovorjavo glasu V na začetku besed", gradient: "from-app-purple/20 to-app-teal/20", image: "zmajcek_crka_V.webp", path: "/govorne-igre/kolo-srece/v" },
