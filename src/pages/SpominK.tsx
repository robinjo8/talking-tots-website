...
export default function SpominK() {
  ...
  const { cards, isLoading, error, flipCard, resetGame, gameCompleted, matchedPairs, totalPairs, isCheckingMatch, showPairDialog, currentMatchedPair, handlePairDialogContinue, handlePairUnmatch } = useMemoryGameK();
  ...
  useEffect(() => {
    if (gameCompleted && gameStartTimeRef.current && gameTime === null) {
      ...
      if (!gameCompletedRef.current) {
        ...
        recordGameCompletion('memory', 'memory_k_game');
