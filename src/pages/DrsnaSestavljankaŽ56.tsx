...
export default function DrsnaSestavljankaŽ56() { return (<AgeGatedRoute requiredAgeGroup="5-6"><DrsnaSestavljankaŽ56Content /></AgeGatedRoute>); }
...
function DrsnaSestavljankaŽ56Content() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('sliding_puzzle', 'sliding_puzzle_ž_5-6'); setShowNewGameButton(true); };
