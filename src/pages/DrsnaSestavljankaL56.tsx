...
const lImages = [
  ...
  { filename: 'lanca.png', word: 'LANCA' },
  { filename: 'led.png', word: 'LED' },
  { filename: 'lev.png', word: 'LEV' },
  { filename: 'limona.png', word: 'LIMONA' },
...
export default function DrsnaSestavljankaL56() {
  return (
    <AgeGatedRoute requiredAgeGroup="5-6">
      <DrsnaSestavljankaL56Content />
    </AgeGatedRoute>
  );
}

function DrsnaSestavljankaL56Content() {
      ...
      <div className="fixed inset-0 bg-background overflow-hidden select-none">
        <div className="h-full flex flex-col">
          <div className="bg-dragon-green/5 p-3 flex-shrink-0 border-b">
            <h2 className="text-lg font-bold mb-3 text-center">Drsna sestavljanka L</h2>
