...
export default function SestavljankeR7to8() {
  return (
    <AgeGatedRoute requiredAgeGroup="7-8">
      <SestavljankeR7to8Content />
    </AgeGatedRoute>
  );
}

function SestavljankeR7to8Content() {
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold">Sestavljanka R - 16 kosov</h1>
          </div>
