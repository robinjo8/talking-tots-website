...
import { wordsDataSSredinaKonec } from "@/data/bingoWordsSSredinaKonec";
...
export default function ArtikulacijaVajeSSredinaKonec() {
  ...
  const {
    ...
    closePopup,
    resetGame
  } = useBingoGame({ words: wordsDataSSredinaKonec, minWordsForWin: 8 });
  ...
  const handleStarClaimed = () => {
    recordExerciseCompletion('artikulacija_bingo_s');
    setStarClaimed(true);
    setShowCongratulations(false);
