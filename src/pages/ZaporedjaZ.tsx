...
export default function ZaporedjaZ() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('memory', 'sequence_z_3-4'); setShowCompletion(false); setShowNewGameButton(true); };
  ...
  return (
    <AgeGatedRoute requiredAgeGroup="3-4">
      <div className="fixed inset-0 overflow-auto select-none" style={{ backgroundImage: `url('${backgroundImageUrl}')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
        <div className="min-h-full flex flex-col items-center justify-center p-4 pb-24"><h1 className="text-3xl md:text-5xl font-bold text-white mb-6 md:mb-8 text-center drop-shadow-lg">ZAPOREDJA - Z</h1><SequenceGameZ key={gameKey} onGameComplete={handleGameComplete} /></div>
