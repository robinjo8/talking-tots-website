...
export default function DrsnaSestavljankaK910() {
  return (
    <AgeGatedRoute requiredAgeGroup="9-10">
      <DrsnaSestavljankaK910Content />
    </AgeGatedRoute>
  );
}

function DrsnaSestavljankaK910Content() {
  ...
  const handleStarClaimed = () => {
    recordGameCompletion('sliding_puzzle', 'sliding_puzzle_k_9-10');
  };
