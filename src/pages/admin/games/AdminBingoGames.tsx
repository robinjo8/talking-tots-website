...
const bingoLetters = [
  { id: "s", letter: "S", title: "Glas S", description: "Igraj bingo in vadi izgovorjavo glasu S", gradient: "from-dragon-green/20 to-dragon-green/20", image: "zmajcek_crka_S.png" },
  { id: "z", letter: "Z", title: "Glas Z", description: "Igraj bingo in vadi izgovorjavo glasu Z", gradient: "from-dragon-green/20 to-dragon-green/20", image: "zmajcek_crka_Z.png" },
  { id: "c", letter: "C", title: "Glas C", description: "Igraj bingo in vadi izgovorjavo glasu C", gradient: "from-dragon-green/20 to-dragon-green/20", image: "zmajcek_crka_C.png" },
  { id: "sh", letter: "Š", title: "Glas Š", description: "Igraj bingo in vadi izgovorjavo glasu Š", gradient: "from-app-yellow/20 to-app-yellow/20", image: "zmajcek_crka_SH.png" },
  { id: "zh", letter: "Ž", title: "Glas Ž", description: "Igraj bingo in vadi izgovorjavo glasu Ž", gradient: "from-app-yellow/20 to-app-yellow/20", image: "zmajcek_crka_ZH.png" },
  { id: "ch", letter: "Č", title: "Glas Č", description: "Igraj bingo in vadi izgovorjavo glasu Č", gradient: "from-dragon-green/20 to-dragon-green/20", image: "zmajcek_crka_CH.png" },
