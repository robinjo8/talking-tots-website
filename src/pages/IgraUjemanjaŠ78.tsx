...
export default function IgraUjemanjaŠ78() {
  const { user } = useAuth();
  ...
  const [items, setItems] = useState<FourColumnMatchingItem[]>(() => getRandomFourColumnItems(4, 'š'));
  ...
  const handleStarClaimed = () => recordGameCompletion('matching_š_7-8');
