...
export default function SestavljankeČ56() {
  return (
    <AgeGatedRoute requiredAgeGroup="5-6">
      <SestavljankeČ56Content />
    </AgeGatedRoute>
  );
}

function SestavljankeČ56Content() {
  ...
  const handleStarClaimed = () => {
    recordGameCompletion('puzzle', 'puzzle_č_12');
  };
      ...
      <div className="fixed inset-0 overflow-hidden select-none relative touch-none overscroll-none">
        ...
        <div className="relative z-10 h-full flex flex-col">
          <div className="p-3 flex-shrink-0">
            <h2 className="text-lg font-bold mb-3 text-center text-white drop-shadow-lg">Sestavljanka Č</h2>
