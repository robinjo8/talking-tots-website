...
const VideoNavodilaCrkaK = () => {
  const videoUrl = "https://ecmtctwovkheohqwahvt.supabase.co/storage/v1/object/public/video-navodila/Glas%20K%20(video).mp4";
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <PageHeader title="Video navodila - K" backPath="/video-navodila" />
...
export default VideoNavodilaCrkaK;
