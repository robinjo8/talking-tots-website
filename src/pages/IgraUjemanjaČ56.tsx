...
export default function IgraUjemanjaČ56() {
  ...
  const [items, setItems] = useState<ThreeColumnMatchingItem[]>(() => getRandomThreeColumnItems(4, 'Č'));
  ...
  // Get letter data for three-column game (fixed to 'č')
  ...
  const handleNewGame = () => {
    ...
    setCompletedItems([]);
    setItems(getRandomThreeColumnItems(4, 'Č'));
  ...
  const handleStarClaimed = () => {
    recordGameCompletion('matching_č_5-6');
  };
