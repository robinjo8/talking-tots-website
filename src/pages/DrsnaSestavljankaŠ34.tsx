...
export default function DrsnaSestavljankaŠ34() {
  return (<AgeGatedRoute requiredAgeGroup="3-4"><DrsnaSestavljankaŠ34Content /></AgeGatedRoute>);
}

function DrsnaSestavljankaŠ34Content() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('sliding_puzzle', 'sliding_puzzle_š_3-4'); setShowCompletion(false); setShowNewGameButton(true); };
