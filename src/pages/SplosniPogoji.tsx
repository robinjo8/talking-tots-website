        ...
        <div className="prose prose-slate max-w-none space-y-6 text-justify">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-3 mt-4">
              ...
              <li><strong>»Preverjanje izgovorjave«</strong> pomeni strukturirano aktivnost na Platformi, pri kateri Otrok izgovarja vnaprej določene besede ali glasove, pri čemer se lahko posnetki shranjujejo, obdelujejo ali pregledajo skladno s funkcionalnostmi Platforme in predmetnimi Splošnimi pogoji.</li>
