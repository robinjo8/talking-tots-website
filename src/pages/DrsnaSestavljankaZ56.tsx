...
export default function DrsnaSestavljankaZ56() { return (<AgeGatedRoute requiredAgeGroup="5-6"><DrsnaSestavljankaZ56Content /></AgeGatedRoute>); }
...
function DrsnaSestavljankaZ56Content() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('sliding_puzzle', 'sliding_puzzle_z_5-6'); setShowNewGameButton(true); };
