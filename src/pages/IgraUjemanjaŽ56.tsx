...
export default function IgraUjemanjaŽ56() {
  ...
  const [items, setItems] = useState<ThreeColumnMatchingItem[]>(() => getRandomThreeColumnItems(4, 'Ž'));
  ...
  // Get letter data for three-column game (fixed to 'ž')
  ...
  const handleNewGame = () => {
    ...
    setItems(getRandomThreeColumnItems(4, 'Ž'));
  ...
  const handleStarClaimed = () => {
    recordGameCompletion('matching_ž_5-6');
  };
