...
import { SequenceGameL910 } from "@/components/exercises/SequenceGameL910";
...
export default function ZaporedjaL910() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('memory', 'sequence_l_9-10'); setShowCompletion(false); setShowNewGameButton(true); };
      ...
      <AgeGatedRoute requiredAgeGroup="9-10">
        <div className="fixed inset-0 overflow-hidden select-none">
          ...
          <div className="relative z-10 flex-1 flex items-center justify-center overflow-hidden h-full w-full p-2">
            {!isPortrait ? (<div className="w-full h-full flex flex-col items-center justify-center"><SequenceGameL910 key={gameKey} onGameComplete={handleGameComplete} isLandscape={true} /></div>) : (<div className="w-full h-full flex items-center justify-center px-6 text-center"><p className="text-base font-semibold text-foreground">Za igranje igre Zaporedja prosim obrni telefon v ležeči položaj.</p></div>)}
          </div>
  ...
  return (
    <AgeGatedRoute requiredAgeGroup="9-10">
      <div className="fixed inset-0 overflow-auto select-none" style={{ backgroundImage: `url('${backgroundImageUrl}')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
        <div className="min-h-full flex flex-col items-center justify-center p-4 pb-24"><h1 className="text-3xl md:text-5xl font-bold text-white mb-6 md:mb-8 text-center drop-shadow-lg">ZAPOREDJA - L</h1><SequenceGameL910 key={gameKey} onGameComplete={handleGameComplete} /></div>
