  ...
  const consonants = [
    {
      ...
      description: "Poveži pare s črko B in nato glasno ponovi besedo"
    },
    {
      letter: "C",
    ...
    },
    {
      ...
      description: "Poveži pare s črko D in nato glasno ponovi besedo"
    },
    {
      letter: "F",
      gradient: "from-app-orange/10 to-app-yellow/10",
      color: "text-app-orange",
      description: "Poveži pare s črko F in nato glasno ponovi besedo"
    },
    {
      letter: "G",
      gradient: "from-dragon-green/10 to-app-teal/10",
      color: "text-dragon-green",
      description: "Poveži pare s črko G in nato glasno ponovi besedo"
    },
    {
      letter: "H",
      gradient: "from-app-blue/10 to-app-purple/10",
      color: "text-app-blue",
      description: "Poveži pare s črko H in nato glasno ponovi besedo"
    },
    {
      letter: "J",
      gradient: "from-app-purple/10 to-app-blue/10",
      color: "text-app-purple",
      description: "Poveži pare s črko J in nato glasno ponovi besedo"
    },
    {
      letter: "K",
      gradient: "from-app-orange/10 to-app-yellow/10",
    ...
    },
    {
      ...
      gradient: "from-app-blue/10 to-app-purple/10",
      color: "text-app-blue",
      description: "Poveži pare s črko M in nato glasno ponovi besedo"
    },
    {
      letter: "N",
      gradient: "from-app-purple/10 to-app-blue/10",
      color: "text-app-purple",
      description: "Poveži pare s črko N in nato glasno ponovi besedo"
    },
    {
      letter: "P",
      gradient: "from-app-orange/10 to-app-yellow/10",
      color: "text-app-orange",
      description: "Poveži pare s črko P in nato glasno ponovi besedo"
    },
    {
      letter: "S",
      gradient: "from-dragon-green/10 to-app-teal/10",
    ...
    },
    {
      ...
      gradient: "from-app-purple/10 to-app-blue/10",
      color: "text-app-purple",
      description: "Poveži pare s črko T in nato glasno ponovi besedo"
    },
    {
      letter: "V",
      gradient: "from-app-orange/10 to-app-yellow/10",
      color: "text-app-orange",
      description: "Poveži pare s črko V in nato glasno ponovi besedo"
    },
    {
      letter: "Z",
      gradient: "from-dragon-green/10 to-app-teal/10",
