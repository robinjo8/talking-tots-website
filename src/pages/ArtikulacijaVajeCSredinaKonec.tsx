...
import { wordsDataCSredinaKonec } from "@/data/bingoWordsCSredinaKonec";
...
export default function ArtikulacijaVajeCSredinaKonec() {
  ...
  const {
    ...
    closePopup,
    resetGame
  } = useBingoGame({ words: wordsDataCSredinaKonec, minWordsForWin: 8 });
  ...
  const handleStarClaimed = () => {
    recordExerciseCompletion('artikulacija_bingo_c');
    setStarClaimed(true);
    setShowCongratulations(false);
