...
import { SequenceGameS910 } from "@/components/exercises/SequenceGameS910";
...
export default function ZaporedjaS910() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('memory', 'sequence_s_9-10'); setShowCompletion(false); setShowNewGameButton(true); };
  ...
  return (
    <AgeGatedRoute requiredAgeGroup="9-10">
      <div className="fixed inset-0 overflow-auto select-none" style={{ backgroundImage: `url('${backgroundImageUrl}')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
        <div className="min-h-full flex flex-col items-center justify-center p-4 pb-24"><h1 className="text-3xl md:text-5xl font-bold text-white mb-6 md:mb-8 text-center drop-shadow-lg">ZAPOREDJA - S</h1><SequenceGameS910 key={gameKey} onGameComplete={handleGameComplete} /></div>
