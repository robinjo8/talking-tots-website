...
export default function SestavljankeZ56() {
  return (
    <AgeGatedRoute requiredAgeGroup="5-6">
      <SestavljankeZ56Content />
    </AgeGatedRoute>
  );
}

function SestavljankeZ56Content() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('puzzle', 'puzzle_z_12'); setShowNewGameButton(true); };
