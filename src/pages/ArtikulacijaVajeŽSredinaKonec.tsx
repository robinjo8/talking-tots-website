...
import { wordsDataŽSredinaKonec } from "@/data/bingoWordsZHSredinaKonec";
...
export default function ArtikulacijaVajeŽSredinaKonec() {
  ...
  const {
    ...
    closePopup,
    resetGame
  } = useBingoGame({ words: wordsDataŽSredinaKonec, minWordsForWin: 8 });
  ...
  const handleStarClaimed = () => {
    recordExerciseCompletion('artikulacija_bingo_ž');
    setStarClaimed(true);
    setShowCongratulations(false);
