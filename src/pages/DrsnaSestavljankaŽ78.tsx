...
export default function DrsnaSestavljankaŽ78() { return (<AgeGatedRoute requiredAgeGroup="7-8"><DrsnaSestavljankaŽ78Content /></AgeGatedRoute>); }
...
function DrsnaSestavljankaŽ78Content() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('sliding_puzzle', 'sliding_puzzle_ž_7-8'); setShowNewGameButton(true); };
