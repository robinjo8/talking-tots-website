...
export default function SpominŽ() {
  ...
  const { cards, isLoading, error, flipCard, resetGame, gameCompleted, matchedPairs, totalPairs, isCheckingMatch, showPairDialog, currentMatchedPair, handlePairDialogContinue, handlePairUnmatch } = useMemoryGameŽ();
  ...
  const handleStarClaimed = () => {
    if (!gameCompletedRef.current) {
      ...
      recordGameCompletion('memory', 'memory_ž_game');
    }
