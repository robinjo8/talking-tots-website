...
export default function DrsnaSestavljankaČ34() {
  return (
    <AgeGatedRoute requiredAgeGroup="3-4">
      <DrsnaSestavljankaČ34Content />
    </AgeGatedRoute>
  );
}

function DrsnaSestavljankaČ34Content() {
  ...
  const handleStarClaimed = () => {
    recordGameCompletion('sliding_puzzle', 'sliding_puzzle_č_3-4');
  };
      ...
      <div className="fixed inset-0 bg-background overflow-hidden select-none">
        <div className="h-full flex flex-col">
          <div className="bg-dragon-green/5 p-3 flex-shrink-0 border-b">
            <h2 className="text-lg font-bold mb-3 text-center">Drsna sestavljanka Č</h2>
