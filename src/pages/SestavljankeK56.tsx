    ...
    <AppLayout>
      <div className="w-full min-h-screen relative">
        ...
        <DropdownMenu open={menuOpen} onOpenChange={setMenuOpen}>
          ...
          <PuzzleSuccessDialog isOpen={showCompletion} onOpenChange={setShowCompletion} completedImage={currentImage} allImages={kImages} onStarClaimed={handleStarClaimed} />
        </div>
      </div>
    </AppLayout>
  );
