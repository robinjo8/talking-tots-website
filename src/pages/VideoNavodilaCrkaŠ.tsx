...
const VideoNavodilaCrkaŠ = () => {
  const videoUrl = "https://ecmtctwovkheohqwahvt.supabase.co/storage/v1/object/public/video-navodila/Glas%20S1%20(video).mp4";
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <PageHeader title="Video navodila - Š" backPath="/video-navodila" />
...
export default VideoNavodilaCrkaŠ;
