...
export default function SestavljankeZ78() {
  return (
    <AgeGatedRoute requiredAgeGroup="7-8">
      <SestavljankeZ78Content />
    </AgeGatedRoute>
  );
}

function SestavljankeZ78Content() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('puzzle', 'puzzle_z_16'); setShowNewGameButton(true); };
  const handleNewGame = () => { gameCompletedRef.current = false; setCurrentImage(getRandomZImage()); setPuzzleKey(prev => prev + 1); setShowNewGameButton(false); };
