...
const gameLetters = [
  ...
  },
  {
    id: "f",
    title: "Glas F",
    description: "Igraj zabavno pot in vadi izgovorjavo glasu F na sredini in koncu besed",
    image: "zmajcek_crka_F.webp",
    path: "/govorne-igre/kace/f",
    gradient: "radial-gradient(ellipse at center, hsl(30, 80%, 95%) 0%, hsl(30, 70%, 88%) 30%, hsl(38, 65%, 78%) 60%, hsl(38, 60%, 68%) 100%)",
    available: true,
  },
  {
    id: "g",
    title: "Glas G",
    description: "Igraj zabavno pot in vadi izgovorjavo glasu G na sredini in koncu besed",
    image: "zmajcek_crka_G.webp",
    path: "/govorne-igre/kace/g",
    gradient: "radial-gradient(ellipse at center, hsl(200, 60%, 95%) 0%, hsl(200, 50%, 88%) 30%, hsl(210, 45%, 78%) 60%, hsl(210, 40%, 68%) 100%)",
    available: true,
  },
  {
    id: "h",
    title: "Glas H",
    description: "Igraj zabavno pot in vadi izgovorjavo glasu H na sredini in koncu besed",
    image: "zmajcek_crka_H.webp",
    path: "/govorne-igre/kace/h",
    gradient: "radial-gradient(ellipse at center, hsl(340, 60%, 95%) 0%, hsl(340, 50%, 88%) 30%, hsl(350, 45%, 78%) 60%, hsl(350, 40%, 68%) 100%)",
    available: true,
  },
  {
    id: "k",
  ...
  },
  {
    id: "v",
    title: "Glas V",
    description: "Igraj zabavno pot in vadi izgovorjavo glasu V na sredini in koncu besed",
    image: "zmajcek_crka_V.webp",
    path: "/govorne-igre/kace/v",
    gradient: "radial-gradient(ellipse at center, hsl(160, 60%, 95%) 0%, hsl(160, 50%, 88%) 30%, hsl(170, 45%, 78%) 60%, hsl(170, 40%, 68%) 100%)",
    available: true,
  },
  {
    id: "z",
