          ...
          <CardContent className="pt-2 flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-base sm:text-lg leading-relaxed">
                ...
                Hkrati gibljemo tudi nekatere druge dele obraza in ust, ki so vključeni v govor 
                in tudi negovorne aktivnosti. Vaje so pomembne za izboljšanje motorike ust, ki z 
                ostalimi deli govornega aparata oblikuje posamezne glasove ter seveda sam govor. 
                Vaje motorike govoril niso pogoj za pojav govora in ne uporabljamo jih pri terapiji 
                vseh govorno-jezikovnih motenj.
              </p>
            </div>
          </CardContent>
        </Card>
