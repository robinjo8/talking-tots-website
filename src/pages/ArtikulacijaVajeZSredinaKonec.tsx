...
import { wordsDataZSredinaKonec } from "@/data/bingoWordsZSredinaKonec";
...
export default function ArtikulacijaVajeZSredinaKonec() {
  ...
  const {
    ...
    closePopup,
    resetGame
  } = useBingoGame({ words: wordsDataZSredinaKonec, minWordsForWin: 8 });
  ...
  const handleStarClaimed = () => {
    recordExerciseCompletion('artikulacija_bingo_z');
    setStarClaimed(true);
    setShowCongratulations(false);
