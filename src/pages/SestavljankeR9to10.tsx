...
export default function SestavljankeR9to10() {
  return (
    <AgeGatedRoute requiredAgeGroup="9-10">
      <SestavljankeR9to10Content />
    </AgeGatedRoute>
  );
}

function SestavljankeR9to10Content() {
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold">Sestavljanka R - 20 kosov</h1>
          </div>
