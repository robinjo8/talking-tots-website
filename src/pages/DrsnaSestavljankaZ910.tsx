...
const zImages = [{ filename: 'zajec.png', word: 'ZAJEC' },{ filename: 'zaslon.png', word: 'ZASLON' },{ filename: 'zavesa.png', word: 'ZAVESE' },{ filename: 'zebra.png', word: 'ZEBRA' },{ filename: 'zlato.png', word: 'ZLATO' },{ filename: 'zmaj.png', word: 'ZMAJ' },{ filename: 'zob.png', word: 'ZOB' },{ filename: 'zobotrebec.png', word: 'ZOBOTREBEC' },{ filename: 'zvezda.png', word: 'ZVEZDA' },{ filename: 'zvocnik.png', word: 'ZVOČNIK' }];

export default function DrsnaSestavljankaZ910() { return (<AgeGatedRoute requiredAgeGroup="9-10"><DrsnaSestavljankaZ910Content /></AgeGatedRoute>); }
...
function DrsnaSestavljankaZ910Content() {
  ...
  const handleStarClaimed = () => { recordGameCompletion('sliding_puzzle', 'sliding_puzzle_z_9-10'); setShowNewGameButton(true); };
