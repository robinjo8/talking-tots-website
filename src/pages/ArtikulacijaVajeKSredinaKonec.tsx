...
import { wordsDataKSredinaKonec } from "@/data/bingoWordsKSredinaKonec";
...
export default function ArtikulacijaVajeKSredinaKonec() {
  ...
  const {
    ...
    closePopup,
    resetGame
  } = useBingoGame({ words: wordsDataKSredinaKonec, minWordsForWin: 8 });
  ...
  const handleStarClaimed = () => {
    recordExerciseCompletion('artikulacija_bingo_k');
    setStarClaimed(true);
    setShowCongratulations(false);
