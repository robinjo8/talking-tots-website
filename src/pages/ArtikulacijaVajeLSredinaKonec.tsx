...
import { wordsDataLSredinaKonec } from "@/data/bingoWordsLSredinaKonec";
...
export default function ArtikulacijaVajeLSredinaKonec() {
  ...
  const {
    ...
    closePopup,
    resetGame
  } = useBingoGame({ words: wordsDataLSredinaKonec, minWordsForWin: 8 });
  ...
  const handleStarClaimed = () => {
    recordExerciseCompletion('artikulacija_bingo_l');
    setStarClaimed(true);
    setShowCongratulations(false);
