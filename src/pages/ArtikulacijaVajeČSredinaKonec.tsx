...
import { wordsDataČSredinaKonec } from "@/data/bingoWordsCHSredinaKonec";
...
export default function ArtikulacijaVajeČSredinaKonec() {
  ...
  const {
    ...
    closePopup,
    resetGame
  } = useBingoGame({ words: wordsDataČSredinaKonec, minWordsForWin: 8 });
  ...
  const handleStarClaimed = () => {
    recordExerciseCompletion('artikulacija_bingo_č');
    setStarClaimed(true);
    setShowCongratulations(false);
