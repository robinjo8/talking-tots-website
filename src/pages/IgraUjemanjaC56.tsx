...
export default function IgraUjemanjaC56() {
  ...
  const [items, setItems] = useState<ThreeColumnMatchingItem[]>(() => getRandomThreeColumnItems(4, 'C'));
  ...
  const handleNewGame = () => {
    ...
    setCompletedItems([]);
    setItems(getRandomThreeColumnItems(4, 'C'));
  ...
  const handleStarClaimed = () => {
    recordGameCompletion('matching_c_5-6');
  };
