...
export default function SestavljankeR3to4() {
  return (
    <AgeGatedRoute requiredAgeGroup="3-4">
      <SestavljankeR3to4Content />
    </AgeGatedRoute>
  );
}

function SestavljankeR3to4Content() {
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold">Sestavljanka R - 6 kosov</h1>
          </div>
