...
export const articulationData: LetterGroup[] = [
  {
    ...
    words: [
      ...
      { text: "OPICA", image: "opica1.webp", audio: "opica.m4a", acceptedVariants: ["OPICA", "APICA", "UPICA", "OPIKA", "OPISA", "OPIČA", "OPICE", "OPICI", "OPICO", "OPICA!", "EPIC", "APIKA", "OPIŠA"] },
  ...
  },
  {
    ...
    words: [
      ...
      { text: "BOBER", image: "bober1.webp", audio: "bober.m4a", acceptedVariants: ["BOBER", "BOBAR", "BOBR", "BOVER", "BOPER", "BOBER!", "BOBRA", "BOBRI", "BOBRU", "DOBER", "GOBER", "OBER", "BOBEJ", "POPEL", "POPEJ", "BOPEJ", "BOPEL"] },
    ]
  },
  {
    letter: "M",
  ...
  },
  {
    letter: "D",
    words: [
      { text: "DEŽNIK", image: "deznik1.webp", audio: "deznik.m4a", acceptedVariants: ["DEŽNIK", "DEZNIK", "DEŠNIK", "TEŽNIK", "BEŽNIK", "DEŽNIKI", "DEŽNIKU", "DEŽNIKA", "DEŽNK", "DEŠNIKI", "TEZNIK", "DEZNIT", "DEŽNIT", "TEZNIT", "TEŠNIT", "TEŠNIK"] },
      { text: "LADJA", image: "ladja1.webp", audio: "ladja.m4a", acceptedVariants: ["LADJA", "LADIA", "RADJA", "NADJA", "LADJO", "LADJE", "LADJI", "LADJA!", "LAJA", "LADIJAA", "BADIA", "JADJA", "LATJA", "JATJA", "ADJA"] },
      { text: "CEDILO", image: "cedilo1.webp", audio: "cedilo.m4a", acceptedVariants: ["CEDILO", "SEDILO", "ČEDILO", "ŠEDILO", "TEDILO", "CEDILA", "CEDILI", "CEDILU", "CEDILO!", "EDILO", "CEDIJO", "SEDIJO"] },
    ]
  },
  {
    letter: "K",
  ...
  },
  {
    ...
    words: [
      ...
      { text: "ŽAGA", image: "zaga1.webp", audio: "zaga.m4a", acceptedVariants: ["ŽAGA", "ZAGA", "ŠAGA", "JAGA", "TAGA", "ŽAGE", "ŽAGI", "ŽAGO", "ŽAGA!", "AGA", "SAGA", "ŽADA", "ŠADA", "SADA"] },
    ]
  },
  {
    letter: "N",
    words: [
      { text: "NOČ", image: "noc1.webp", audio: "noc.m4a", acceptedVariants: ["NOČ", "NOC", "NOŠ", "MOČ", "KOČ", "NOČ!", "NOČI", "NOČA", "NOČAA", "TOČ", "BOČ", "NOJ", "NOT", "OČ", "OŠ"] },
  ...
  },
  {
    ...
    words: [
      ...
      { text: "DREVO", image: "drevo1.webp", audio: "drevo.m4a", acceptedVariants: ["DREVO", "TREVO", "KREVO", "BREVO", "DEVO", "DREVU", "DREVA", "DREVOO", "DREVO!", "LEVO", "REVO", "DJEVO", "TJEVO", "TLEVO"] },
      { text: "SOVA", image: "sova1.webp", audio: "sova.m4a", acceptedVariants: ["SOVA", "ZOVA", "ŠOVA", "TOVA", "BOVA", "SOVE", "SOVI", "SOVO", "SOVA!", "SOVAA", "SOFA", "OVA"] },
    ]
  },
  {
    letter: "J",
  ...
  },
  {
    ...
    words: [
      ...
      { text: "LOS", image: "los1.webp", audio: "los.m4a", acceptedVariants: ["LOS", "LOŠ", "LOZ", "LOT", "KOS", "MOS", "LOSA", "LOSI", "LOSU", "LOS!", "OS", "LOB", "JOS"] },
    ]
  },
  {
    letter: "Z",
    words: [
      { text: "ZMAJ", image: "zmaj1.webp", audio: "zmaj.m4a", acceptedVariants: ["ZMAJ", "SMAJ", "ŠMAJ", "ŽMAJ", "MAJ", "ZMAJA", "ZMAJI", "ZMAJU", "ZMAJ!", "ZMAI", "ŠMAJI", "TMAJ"] },
      ...
      { text: "KOZA", image: "koza1.webp", audio: "koza.m4a", acceptedVariants: ["KOZA", "KOSA", "KOŽA", "KOŠA", "BOZA", "DOZA", "KOZE", "KOZI", "KOZO", "KOZA!", "GOZA", "TOZA", "TOSA", "OZA", "OSA"] },
    ]
  },
  {
    letter: "C",
    words: [
      ...
      { text: "RACA", image: "raca1.webp", audio: "raca.m4a", acceptedVariants: ["RACA", "RACE", "RACI", "RACO", "RAZA", "RAŠA", "RASA", "LACA", "NACA", "DACA", "RACA!", "ACA", "LASA", "JASA", "RAČA"] },
  ...
  },
  {
    letter: "Š",
    words: [
      { text: "ŠOTOR", image: "sotor1.webp", audio: "sotor.m4a", acceptedVariants: ["ŠOTOR", "SOTOR", "ŽOTOR", "ŠOTAR", "ŠOTOT", "ŠOTORA", "ŠOTORI", "ŠOTORU", "ŠOTOR!", "OTOR", "STOTOR", "ŠOTOJ", "SOTOJ", "SOTOL"] },
      { text: "PIŠKOT", image: "piskot1.webp", audio: "piskot.m4a", acceptedVariants: ["PIŠKOT", "PISKOT", "PIŠČOT", "PIŠKOC", "PIŠKOTI", "PIŠKOTU", "PIŠKOTA", "PIŠKT", "ŠKOT", "BISKOT", "PIŠKOT!", "KOT"] },
  ...
  },
  {
    letter: "Ž",
    words: [
      { text: "ŽABA", image: "zaba1.webp", audio: "zaba.m4a", acceptedVariants: ["ŽABA", "ZABA", "ŠABA", "JABA", "TABA", "ŽABE", "ŽABI", "ŽABO", "ŽABA!", "ABA", "ŠABA", "ŠAPA", "ZAPA", "ZAVA"] },
      { text: "ROŽA", image: "roza1.webp", audio: "roza.m4a", acceptedVariants: ["ROŽA", "ROZA", "ROŠA", "ROŽE", "LOŽA", "LOZA", "LOŠA", "JOŽA", "JOZA", "ROŽA!", "ROŽA?", "ROŽAA"] },
      { text: "LUŽA", image: "luza1.webp", audio: "luza.m4a", acceptedVariants: ["LUŽA", "LUZA", "LUJA", "LUŠA", "BUŽA", "DUŽA", "LUŽE", "LUŽI", "LUŽO", "LUŽA!", "UŽA", "LUTA", "LUSA", "JUŽA", "JUŠA", "JUZA", "JUSA"] },
    ]
  },
  {
    letter: "Č",
    words: [
      ...
      { text: "ČOPIČ", image: "copic1.webp", audio: "copic.m4a", acceptedVariants: ["ČOPIČ", "ČOPIC", "ŠOPIČ", "COPIČ", "ČOPIŠ", "ČOPIT", "ČOPIČA", "ČOPIČI", "ČOPIČU", "ČOPIČ!", "OPIČ", "TOPIT", "ŠOPIŠ", "COPIC"] },
    ]
  },
  {
    letter: "R",
    words: [
      { text: "RIBA", image: "riba1.webp", audio: "riba.m4a", acceptedVariants: ["RIBA", "LIBA", "JIBA", "REBA", "RIVA", "RIBE", "RIBI", "RIBO", "RIBA!", "IBA", "REBA", "IPA"] },
      { text: "OMARA", image: "omara1.webp", audio: "omara.m4a", acceptedVariants: ["OMARA", "OMARE", "OMARI", "OMARO", "AMARA", "UMARA", "OMARA!", "MARA", "OMALA", "OMARAA", "OMAJA", "MAJA", "MALA"] },
