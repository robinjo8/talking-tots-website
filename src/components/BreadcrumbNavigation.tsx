...
const breadcrumbConfig: BreadcrumbConfig[] = [
  ...
  { path: "/govorne-igre/bingo/f", label: "F", parent: "/govorne-igre/bingo" },
  { path: "/govorne-igre/bingo/g", label: "G", parent: "/govorne-igre/bingo" },
  { path: "/govorne-igre/bingo/h", label: "H", parent: "/govorne-igre/bingo" },
  ...
  { path: "/govorne-igre/bingo/r-zacetek", label: "R - začetne vaje", parent: "/govorne-igre/bingo" },
  { path: "/govorne-igre/bingo/s", label: "S", parent: "/govorne-igre/bingo" },
  { path: "/govorne-igre/bingo/sh", label: "Š", parent: "/govorne-igre/bingo" },
  { path: "/govorne-igre/bingo/v", label: "V", parent: "/govorne-igre/bingo" },
