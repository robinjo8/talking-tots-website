    ...
    <>
      <section className="pt-20 pb-8 px-4 md:pt-28 md:pb-16 md:px-6 lg:px-8 relative w-full">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {isMobile && (
            <div className={`flex flex-col items-center text-center space-y-6 w-full ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-700 ease-out`}>
