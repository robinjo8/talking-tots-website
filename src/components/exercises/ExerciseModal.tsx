...
export const ExerciseModal = ({
  ...
  return <div className="fixed inset-0 z-50 bg-black/90 flex items-center justify-center p-4">
      <button onClick={onClose} className="absolute top-4 right-4 z-10 text-white hover:text-gray-300 transition-colors">
        <X className="h-6 w-6" />
      </button>
      ...
      <div className="w-full max-w-4xl mx-auto text-center">
        ...
        <div className="bg-white rounded-xl p-4 shadow-2xl">
          <img src={imageUrl} alt={`Vaja ${cardNumber}: ${instruction}`} className="w-full max-w-2xl mx-auto rounded-lg" onError={e => {
        ...
        <button onClick={onComplete} className="mt-6 px-6 py-3 rounded-lg transition-colors text-base font-semibold text-base bg-neutral-50 text-zinc-950">Zapri</button>
