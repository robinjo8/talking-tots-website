    ...
    <div className="bg-background border-b border-gray-100 sticky top-20 z-40">
      <div className="container max-w-5xl mx-auto px-4 py-4">
        <div className="flex items-center gap-4">
          {/* Back Button - Left arrow in green circle */}
          <Button 
            variant="ghost" 
            size="icon"
          ...
          {/* Page Title */}
          <h1 className="text-xl md:text-2xl font-bold text-foreground whitespace-nowrap overflow-hidden text-ellipsis flex-1">
            {title}
          </h1>
        </div>
      </div>
