...
import { CookieSettingsDialog, CookiePreferences } from './CookieSettingsDialog';

export function CookieConsentBanner() {
  const { showBanner, acceptAll, rejectAll, saveCustomPreferences, consent } = useCookieConsent();
