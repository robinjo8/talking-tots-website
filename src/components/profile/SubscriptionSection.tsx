...
export function SubscriptionSection() {
  ...
  const features = [
    ...
    { icon: <Gamepad2 className="h-4 w-4 text-dragon-green" />, text: "Dostop do govornih vaj in iger" },
    { icon: <Video className="h-4 w-4 text-dragon-green" />, text: "Video navodila logopeda" },
    { icon: <BookOpen className="h-4 w-4 text-dragon-green" />, text: "Logopedski nasveti za starše" },
    { icon: <MessageCircle className="h-4 w-4 text-dragon-green" />, text: "Pogovor s pametnim AI asistentom" },
    { icon: <TrendingUp className="h-4 w-4 text-dragon-green" />, text: "Sledenje napredku otroka" },
    { icon: <FileText className="h-4 w-4 text-dragon-green" />, text: "Prilagojen govorni načrt" }
  ];
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Tabs value={selectedPlan} onValueChange={(value) => setSelectedPlan(value as 'monthly' | 'yearly')} className="w-full mb-8">
            ...
            <TabsContent value="monthly" className="mt-6">
              <Card className="relative border-2 transition-all duration-300 hover:shadow-lg border-dragon-green/50 shadow-md">
                <CardContent className="p-8">
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-bold text-dragon-green mb-2">Mesečna naročnina</h3>
            ...
            <TabsContent value="yearly" className="mt-6">
              <Card className="relative border-2 transition-all duration-300 hover:shadow-lg border-dragon-green shadow-md">
                <CardContent className="p-8">
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <span className="bg-dragon-green text-white text-xs sm:text-sm px-3 sm:px-4 py-1 rounded-full font-medium whitespace-nowrap">
