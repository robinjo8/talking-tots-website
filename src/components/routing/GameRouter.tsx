...
const IMPORT_MAPS: Record<string, Record<string, () => Promise<{ default: ComponentType<any> }>>> = {
  sestavljanke: {
    ...
    'č': () => import('@/pages/SestavljankeČ'),
    'č56': () => import('@/pages/SestavljankeČ56'),
    'č78': () => import('@/pages/SestavljankeČ78'),
    'č910': () => import('@/pages/SestavljankeČ910'),
    ...
    'š': () => import('@/pages/SestavljankeŠ'),
    'š56': () => import('@/pages/SestavljankeŠ56'),
    'š78': () => import('@/pages/SestavljankeŠ78'),
    'š910': () => import('@/pages/SestavljankeŠ910'),
    ...
    'ž': () => import('@/pages/SestavljankeŽ'),
    'ž56': () => import('@/pages/SestavljankeŽ56'),
    'ž78': () => import('@/pages/SestavljankeŽ78'),
    'ž910': () => import('@/pages/SestavljankeŽ910'),
  },
  zaporedja: {
    ...
    'č': () => import('@/pages/ZaporedjaČ'),
    'č56': () => import('@/pages/ZaporedjaČ56'),
    'č78': () => import('@/pages/ZaporedjaČ78'),
    'č910': () => import('@/pages/ZaporedjaČ910'),
    ...
    'š': () => import('@/pages/ZaporedjaŠ'),
    'š56': () => import('@/pages/ZaporedjaŠ56'),
    'š78': () => import('@/pages/ZaporedjaŠ78'),
    'š910': () => import('@/pages/ZaporedjaŠ910'),
    'z': () => import('@/pages/ZaporedjaZ'),
    'z56': () => import('@/pages/ZaporedjaZ56'),
    'z78': () => import('@/pages/ZaporedjaZ78'),
    'z910': () => import('@/pages/ZaporedjaZ910'),
    'ž': () => import('@/pages/ZaporedjaŽ'),
    'ž56': () => import('@/pages/ZaporedjaŽ56'),
    'ž78': () => import('@/pages/ZaporedjaŽ78'),
    'ž910': () => import('@/pages/ZaporedjaŽ910'),
  },
  'drsna-sestavljanka': {
    ...
    'č34': () => import('@/pages/DrsnaSestavljankaČ34'),
    'č56': () => import('@/pages/DrsnaSestavljankaČ56'),
    'č78': () => import('@/pages/DrsnaSestavljankaČ78'),
    'č910': () => import('@/pages/DrsnaSestavljankaČ910'),
    ...
    'š34': () => import('@/pages/DrsnaSestavljankaŠ34'),
    'š56': () => import('@/pages/DrsnaSestavljankaŠ56'),
    'š78': () => import('@/pages/DrsnaSestavljankaŠ78'),
    'š910': () => import('@/pages/DrsnaSestavljankaŠ910'),
    ...
    'ž34': () => import('@/pages/DrsnaSestavljankaŽ34'),
    'ž56': () => import('@/pages/DrsnaSestavljankaŽ56'),
    'ž78': () => import('@/pages/DrsnaSestavljankaŽ78'),
    'ž910': () => import('@/pages/DrsnaSestavljankaŽ910'),
  },
  'igra-ujemanja': {
    ...
    'č': () => import('@/pages/IgraUjemanjaČ'),
    'č56': () => import('@/pages/IgraUjemanjaČ56'),
    'č78': () => import('@/pages/IgraUjemanjaČ78'),
    'č910': () => import('@/pages/IgraUjemanjaČ910'),
    ...
    'š': () => import('@/pages/IgraUjemanjaŠ'),
    'š56': () => import('@/pages/IgraUjemanjaŠ56'),
    'š78': () => import('@/pages/IgraUjemanjaŠ78'),
    'š910': () => import('@/pages/IgraUjemanjaŠ910'),
    ...
    'ž': () => import('@/pages/IgraUjemanjaŽ'),
    'ž56': () => import('@/pages/IgraUjemanjaŽ56'),
    'ž78': () => import('@/pages/IgraUjemanjaŽ78'),
    'ž910': () => import('@/pages/IgraUjemanjaŽ910'),
  },
  spomin: {
    'spomin-c': () => import('@/pages/SpominC'),
    'spomin-č': () => import('@/pages/SpominČ'),
    'spomin-k': () => import('@/pages/SpominK'),
    'spomin-l': () => import('@/pages/SpominL'),
    'spomin-r': () => import('@/pages/SpominR'),
    'spomin-s': () => import('@/pages/SpominS'),
    'spomin-š': () => import('@/pages/SpominŠ'),
    'spomin-z': () => import('@/pages/SpominZ'),
    'spomin-ž': () => import('@/pages/SpominŽ'),
  },
};
